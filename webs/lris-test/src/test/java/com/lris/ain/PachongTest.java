...
public class PachongTest{
	...
	public static void main(String[] args) throws Exception {
		PachongTest pachongTest=new PachongTest();
    ...
    private static void downloadPicture(String urlList) throws Exception{
        ...
        try {
            ...
            FileOutputStream fileOutputStream = new FileOutputStream(new File("G:\\lris\\test\\"+System.currentTimeMillis()+".jpg"));
